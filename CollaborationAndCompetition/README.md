...
2. Place the file in the DRLND GitHub repository, in the `CollaborationAndCompetition/` folder, and unzip (or decompress) the file. 
3. `conda create --name drlnd python3.6`
4. `source activate drlnd`
5. clone the repository `git clone https://github.com/kantologist/udacity-drlnd.git`
...
`python main.py --mode multiagent` as explained [here](../README.md)
